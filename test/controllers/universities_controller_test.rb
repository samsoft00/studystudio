...
class UniversitiesControllerTest < ActionController::TestCase
  ...
  test "should create university" do
    assert_difference('University.count') do
      post :create, university: { logo: @university.logo, name: @university.name, portal: @university.portal, site: @university.site, subdomain: @university.subdomain }
    end
  ...
  test "should update university" do
    patch :update, id: @university, university: { logo: @university.logo, name: @university.name, portal: @university.portal, site: @university.site, subdomain: @university.subdomain }
    assert_redirected_to university_path(assigns(:university))
  end
